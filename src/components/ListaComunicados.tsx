...
const ListaComunicados = ({ comunicados, loading, showDocumentLink = false }: ListaComunicadosProps) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {filtrados.map((c) => (
        <div key={c.id} className="bg-primary/10 border border-primary/30 rounded-lg p-4 space-y-2 cursor-pointer hover:bg-primary/15 transition-colors" onClick={() => setSelectedItem(c)}>
