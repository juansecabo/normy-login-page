              ...
              <table className="w-full border-collapse">
                ...
                <tfoot>
                  <tr className="bg-muted/30">
                    {/* Celdas fijas vacías - sticky solo en desktop, z-index bajo para no cubrir botones */}
                    <td className="md:sticky md:left-0 z-[1] bg-muted/30 border border-border p-1"></td>
                    <td className="md:sticky md:left-[100px] z-[1] bg-muted/30 border border-border p-1"></td>
                    <td className="md:sticky md:left-[280px] z-[1] bg-muted/30 border border-border p-1"></td>
