        ...
        <div className="bg-card rounded-lg shadow-soft overflow-hidden">
          ...
          <div className="flex border-b border-border">
            {periodos.map((periodo) => {
              ...
              // Mobile: "1°" | Desktop: "1er Periodo"
              const labelMobile = `${periodo.numero}°`;
              return (
                <button
                  key={periodo.numero}
                  onClick={() => setPeriodoActivo(periodo.numero)}
                  className={`flex-1 px-1 md:px-4 py-2 md:py-3 text-xs md:text-sm font-medium transition-colors relative
                    ${isActive 
                ...
                >
                  <span className="flex items-center justify-center gap-1">
                    ...
                    <span className={estaCompleto ? 'text-green-300' : ''}>
                      ...
                      <span className="md:hidden">({porcentajePromedio}%)</span>
                    </span>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-primary text-primary-foreground">
                    ...
                    <th className="md:sticky left-0 z-20 bg-primary border border-border/30 w-[100px] min-w-[100px] p-3 text-left font-semibold">
                      Código
                    </th>
                  ...
                  {estudiantes.map((estudiante, studentIndex) => {
                    ...
                    return (
                      <tr 
                        ...
                        className={rowBg}
                      >
                        {/* Fixed columns in desktop, scrollable on mobile */}
                        <td className={`md:sticky left-0 z-10 border border-border p-3 text-sm ${rowBg}`}>
