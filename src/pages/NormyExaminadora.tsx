  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="container mx-auto flex items-center justify-between">
          <Link to="/dashboard" className="flex items-center gap-2 sm:gap-3 hover:opacity-80 transition-opacity cursor-pointer">
            <img
              src={escudoImg}
              alt="Escudo"
              className="w-10 h-10 sm:w-16 sm:h-16 object-contain sm:-my-2"
            />
          ...
          <Button
            ...
            className="font-medium text-xs sm:text-sm px-2 sm:px-4 h-8 sm:h-10"
          >
            Cerrar sesión
          </Button>
        </div>
      ...
      <main className="flex-1 container mx-auto p-8">
        ...
        <div className="bg-card rounded-lg shadow-soft p-6 sm:p-8 max-w-3xl mx-auto text-center mb-8 relative overflow-hidden">
          {/* Normy in background - hidden on mobile, shown on desktop */}
          <img
            src={normyImg}
            alt="Normy Examinadora"
            className="hidden sm:block absolute right-0 top-1/2 -translate-y-1/2 h-full w-auto object-contain pointer-events-none"
          />
          <div className="relative z-10">
            ...
            <p className="text-base sm:text-lg text-primary font-semibold mt-4">
              {nombres} {apellidos}
            </p>
          </div>
          {/* Normy on mobile - below text, smaller */}
          <img
            src={normyImg}
            alt="Normy Examinadora"
            className="sm:hidden mx-auto mt-4 h-32 w-auto object-contain"
          />
        </div>
